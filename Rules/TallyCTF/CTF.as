...
void Config(CTFCore@ this)
{
	...
	s32 warmUpTimeSeconds = rules.exists("custom_warmup_time") ? rules.get_s32("custom_warmup_time") : cfg.read_s32("warmup_time", 30);
	...
	s32 gameDurationMinutes = rules.exists("custom_game_time") ? rules.get_s32("custom_game_time") : cfg.read_s32("game_time", -1);
...
void Reset(CRules@ this)
{
	...
	this.set_u32("game_end_time", getGameTime() + core.gameDuration + core.warmUpTime); //for TimeToEnd.as
}
